      ...
      messages=[
        {
          ...
          "content": [
            {
              "type": "text",
              "text": f"Я модерую маленький сайт з новинами. На іншому сайті я знайшов новину яку хочу розмістити у себе, тому склади короткий зміст наступного тексту:\n\n{text}\n"
            }
          ]
        }
      ],
...
def main_loop():
    while True:
        process_data()
        print('WORKS')
        time.sleep(300)  # Затримка на 5 хвилин
